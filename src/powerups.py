...
class Powerups:
    ...
    def on_buy(self, user_id, current_time):
        ...
        ----------
        user_id (int/str):
            id of the user who bought the powerup
        current_time (int):
...
class PowerupsNonPermanent(Powerups):
    """
...
class CooldownReduction(PowerupsNonPermanent):
    """
...
class PiflouzMultiplier(PowerupsNonPermanent):
    """
...
class BirthdayMultiplier(PiflouzMultiplier):
    """
...
class PowerupsPermanent(Powerups):
    """
    Permanent powerups
    """
...
class MinerPowerup(PowerupsPermanent):
    """
    ...
    def actions_every_hour(self, user_id):
        ...
        add_to_stat(piflouz_earned, PiflouzSource.MINER)


class PiboxDropRateMultiplier(PowerupsPermanent):
    """
...
class ComboMaxIncrease(PowerupsPermanent):
    """
...
class ComboRewardMultiplier(PowerupsPermanent):
    """
...
class PiboxSizeMultiplier(PowerupsPermanent):
    """
...
class StorePriceMultiplier(PowerupsPermanent):
    """
